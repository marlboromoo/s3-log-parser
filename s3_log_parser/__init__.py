...
FORMAT_STRINGS = [
    ...
    [make_regex('%o'), '([A-Z\.\_]*)', lambda match: 'operation', lambda matched_strings: matched_strings], #The operation listed here is declared as SOAP.operation, REST.HTTP_method.resource_type, WEBSITE.HTTP_method.resource_type, or BATCH.DELETE.OBJECT.
